...
class _AuthApi implements AuthApi {
  ...
  Future<HttpResponse<UpdateEmailResponse>> updateEmail({
    required String bearerToken,
    required UpdateEmailRequest request,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': bearerToken};
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<HttpResponse<UpdateEmailResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/user/email',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UpdateEmailResponse _value;
    try {
      _value = UpdateEmailResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<UpdateSalaryResponse>> updateSalary({
    required String bearerToken,
    required UpdateSalaryRequest request,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': bearerToken};
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<HttpResponse<UpdateSalaryResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/user/salary',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UpdateSalaryResponse _value;
    try {
      _value = UpdateSalaryResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<UpdatePasswordResponse>> updatePassword({
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<HttpResponse<UpdatePasswordResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/user/password',
